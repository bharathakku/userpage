...
// Normalize API base to ensure '/api' suffix exists
const RAW_API = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:4001'
export const API_BASE_URL = RAW_API.endsWith('/api') ? RAW_API : `${RAW_API.replace(/\/$/, '')}/api`;
